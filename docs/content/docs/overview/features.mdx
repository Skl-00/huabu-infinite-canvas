---
title: Features
description: Major features currently available in HuaBu Canvas
---
...
- Use built-in prompt sources from the [Image Prompts](https://github.com/yukkcat/image-prompts) registry, with independent enablement, manual refresh, and scheduled refresh.
