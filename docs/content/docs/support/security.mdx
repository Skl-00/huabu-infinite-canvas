...
See [SECURITY.md](https://github.com/Skl-00/huabu-infinite-canvas/blob/main/SECURITY.md). Do not post exploit details, private API keys, sensitive screenshots, or real user data in a public issue.

Use GitHub private vulnerability reporting or a Security Advisory. If the private channel is unavailable, open a public issue asking for a private reporting route without including vulnerability details.
