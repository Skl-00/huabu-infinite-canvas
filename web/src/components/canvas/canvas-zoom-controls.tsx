...
export function CanvasZoomControls({ scale, onScaleChange, onReset, isMiniMapOpen, onToggleMiniMap }: CanvasZoomControlsProps) {
    ...
    return (
        <div className="canvas-zoom-dock" aria-label="缩放控制" onMouseDown={(event) => event.stopPropagation()} onPointerDown={(event) => event.stopPropagation()}>
            <div className="flex h-12 items-center gap-1 rounded-lg border px-2 shadow-sm backdrop-blur" style={dockStyle}>
