...
export function CanvasConfigComposer({ nodeId, nodes, value, inputs, connections, onChange, onClose, onDisconnectReference, onStartReferenceSelection }: CanvasConfigComposerProps) {
    ...
    return (
        ...
        >
            ...
            <CanvasNodeReferenceBar nodeId={nodeId} nodes={nodes} connections={connections} onDisconnect={onDisconnectReference} onStartSelection={onStartReferenceSelection} />
