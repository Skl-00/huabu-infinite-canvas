export default {
    ...
    canvas: {
        ...
        connecting: "Connecting",
         ...
         search: "Search canvases, workspaces, or nodes",
         searchPlaceholder: "Search canvas, workspace, or node names",
         noSearchResults: "No matching canvases",
         searchHint: "Search by project name, workspace name, or node title.",
         projectSummary: { projects: "{{count}} projects", scenes: "{{count}} workspaces", nodes: "{{count}} nodes", connections: "{{count}} connections" },
        ...
        toolbar: {
            ...
            themeMode: "Theme", light: "Light", dark: "Dark", gridStyle: "Grid style", dots: "Dots", lines: "Lines", blank: "Blank", imageInfo: "Image info", defaultImageSize: "Default image size", showConnections: "Show connections",
        },
        project: {
    ...
    home: {
        ...
        workspaceTitle: "Start with an idea, keep the result",
        workspaceDescription: "Choose a starting point. Your work stays connected across canvases, assets, and prompts.",
        quickCreate: "Start quickly",
        communityTitle: "Prompt community",
        communityDescription: "Browse reusable prompts and bring proven methods back into your canvas workflow.",
        openCommunity: "Open prompt community",
        createImage: "Generate image",
        createImageDescription: "Begin an image run from a prompt and references.",
        createVideo: "Generate video",
        createVideoDescription: "Organize shots, references, and video tasks.",
        createCanvas: "New canvas",
        createCanvasDescription: "Keep stories, assets, and generations in one canvas.",
        libraryTitle: "Your creative library",
        libraryDescription: "Continue from existing projects, prompts, and assets instead of starting blank.",
        recentCanvases: "Recent canvases",
        recentAssets: "My assets",
        recentPrompts: "Prompt library",
        openLibrary: "View all",
        emptyCanvases: "No canvas projects yet",
        createFirstCanvas: "Create your first canvas",
    ...
    config: {
        ...
        localStorage: {
            ...
            backup: {
                title: "Local data backup and restore",
                description: "Package canvases, assets, generation runs, and local media into a ZIP for workspace migration or recovery.",
                security: "Backups exclude provider settings, API keys, model scripts, WebDAV passwords, and other connection credentials. Import replaces current canvas, asset, and task records.",
                export: "Export local data",
                import: "Import local data",
                exported: "Exported {{projects}} canvases, {{assets}} assets, {{runs}} runs, and {{files}} media files",
                imported: "Restored {{projects}} canvases, {{assets}} assets, {{runs}} runs, and {{files}} media files",
                exportFailed: "Failed to export local data",
                importFailed: "Failed to import local data",
                importTitle: "Restore local data?",
                importDescription: "Import replaces the current canvases, assets, generation runs, and legacy history. Provider settings remain unchanged. Confirm that this is the correct backup.",
            },
        },
        promptSources: {
            add: "Add source",
