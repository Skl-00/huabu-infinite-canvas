export default {
    ...
    canvas: {
        ...
        connecting: "连接中",
         ...
         search: "搜索画布、工作画布或节点",
         searchPlaceholder: "搜索画布、工作画布或节点名称",
         noSearchResults: "没有找到匹配的画布",
         searchHint: "可按项目名称、工作画布名称或节点标题搜索。",
         projectSummary: { projects: "{{count}} 个项目", scenes: "{{count}} 张工作画布", nodes: "{{count}} 个节点", connections: "{{count}} 条连线" },
        ...
        toolbar: {
            ...
            themeMode: "主题模式", light: "浅色", dark: "深色", gridStyle: "网格样式", dots: "点", lines: "线", blank: "空白", imageInfo: "图片信息", defaultImageSize: "默认生图画幅", showConnections: "显示连线",
        },
        project: {
    ...
    home: {
        ...
        workspaceTitle: "从一个想法开始，把结果留下来",
        workspaceDescription: "选择一个入口开始创作，过程会沉淀到画布、素材和提示词库中。",
        quickCreate: "快速开始",
        communityTitle: "提示词社区",
        communityDescription: "浏览可复用的提示词，把成熟方法带回你的画布和生成工作流。",
        openCommunity: "进入提示词社区",
        createImage: "生成图片",
        createImageDescription: "从提示词和参考图开始一轮生图。",
        createVideo: "生成视频",
        createVideoDescription: "组织镜头、参考素材和视频任务。",
        createCanvas: "新建画布",
        createCanvasDescription: "把故事、资产和生成结果放进同一张画布。",
        libraryTitle: "你的创作资料",
        libraryDescription: "从已有项目、提示词和素材继续，不必从空白开始。",
        recentCanvases: "最近画布",
        recentAssets: "我的资产",
        recentPrompts: "提示词库",
        openLibrary: "查看全部",
        emptyCanvases: "还没有画布项目",
        createFirstCanvas: "创建第一张画布",
    ...
    config: {
        ...
        localStorage: {
            ...
            backup: {
                title: "本地数据备份与恢复",
                description: "将画布、资产、生成任务和本地媒体打包为 ZIP，用于迁移或恢复当前浏览器中的工作区。",
                security: "备份不包含 API 配置、API Key、模型脚本、WebDAV 密码或其他连接凭据。导入会替换当前画布、资产和任务记录。",
                export: "导出本地数据",
                import: "导入本地数据",
                exported: "已导出 {{projects}} 个画布、{{assets}} 个资产、{{runs}} 条任务和 {{files}} 个媒体文件",
                imported: "已恢复 {{projects}} 个画布、{{assets}} 个资产、{{runs}} 条任务和 {{files}} 个媒体文件",
                exportFailed: "本地数据导出失败",
                importFailed: "本地数据导入失败",
                importTitle: "恢复本地数据？",
                importDescription: "导入会替换当前浏览器中的画布、资产、生成任务和旧版历史，API 配置不会改变。请确认已选择正确的备份包。",
            },
        },
        promptSources: {
            add: "新增来源",
